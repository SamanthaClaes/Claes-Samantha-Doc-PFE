---
title: Catégorie Opquast
---

## Identification et contact
La page d'accueil expose la nature des contenus et services proposés. 

![Titre et services](../assets/opquast/about.png)
![Titre et services](../assets/opquast/services.png)

Au moins deux moyens de contact sont proposés. 

![Moyens de contact](../assets/opquast/contact.png)

## Internationalisation
Les liens d'accès aux versions traduites pointent directement vers la traduction de la page courante. 
![Traduction](../assets/opquast/trad.png)

Le code source de chaque page indique la langue principale du contenu. 
![Traduction](../assets/opquast/lang.png)

## Navigation 
Il est possible de revenir à la page d'accueil depuis toutes les pages. 

![Navigation](../assets/opquast/logo.png)

Les items actifs de menu sont signalés. 
![Navigation](../assets/opquast/actif.png)

## Présentation
La charte graphique est cohérente sur toutes les pages. 

![Charte graphique](../assets/opquast/charte.png)
![Charte graphique](../assets/opquast/charte2.png)
![Charte graphique](../assets/opquast/charte3.png)
![Charte graphique](../assets/opquast/charte4.png)

La taille des éléments cliquables est suffisante. 

![Charte graphique](../assets/opquast/button.png)
![Charte graphique](../assets/opquast/button2.png)
![Charte graphique](../assets/opquast/button3.png)
![Charte graphique](../assets/opquast/button4.png)
